...
- A$\beta$ is very hydrophobic and thus difficult to study experimentally

### Future applications of IDP simulations
1. better understanding of how IDPs bind to other proteins
    - e.g. [pYEEI+ to SH2 domain](https://pubs.acs.org/doi/10.1021/ct300003f)
2. understanding why IDP is advantageous
    - conformational selection?
    - induced fit mechanism?
3. longer peptides with more complex binding profiles
4. nucleation and growth of fibrils
5. **identify and drug metastable conformations**
    - [example success](https://www.nature.com/articles/nchembio.1528)
    - [simulations for druggability (c-myc)](https://journals.plos.org/plosone/article?id=10.1371/journal.pone.0041070)